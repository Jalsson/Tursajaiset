<div class="nav-bar">
    <div class="row">
        <div id="nav-home" class="col nav-col">
            <img class="nav-icon" src="images/search-icon.png" alt="home">
            <p class="nav-text" >Hae</p>
        </div>
        <div id="nav-stats" class="col nav-col">
            <img class="nav-icon" src="images/list-icon.png" alt="list-icon">
            <p class="nav-text" >Tilastot</p>
        </div>
...
<script>
    ...
    $('#nav-stats').click(function() {
        disableButtons()
    $("#nav-stats").css("opacity","1");
    window.location = '?page=stats';
    });
